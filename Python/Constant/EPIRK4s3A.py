...
def EPIRK4s3A(u, T_final, substeps, RHS_function, c, Gamma, Leja_X, tol, Real_Imag):
    """
    Parameters
    ----------
    u                       : numpy array
    ...
    u_flux_2, rhs_calls_2, substeps = linear_phi([zero_vec, rhs_u*T_final], T_final, substeps, Jac_vec, 2/3, c, Gamma, Leja_X, tol)
    ...
    u_flux, rhs_calls_3, substeps = linear_phi([zero_vec, rhs_u*T_final, zero_vec, (32*R_a-27/2*R_b)*T_final, (-144*R_a+81*R_b)*T_final], T_final, substeps, Jac_vec, 1, c, Gamma, Leja_X, tol)
