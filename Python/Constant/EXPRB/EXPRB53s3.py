...
def EXPRB53s3(u, dt, RHS_func, c, Gamma, rel_tol, Real_Imag_Leja):
    """
    Parameters
    ----------
	u               : 1D vector u (input)
    ...
    ### Internal stage 2
    b_n_f,  rhs_calls_3 = Leja_phi(u, 9*dt/10, RHS_func, f_u, c, Gamma, phi_1, rel_tol)
    b_n_nl_1, rhs_calls_4 = Leja_phi(u, dt/2, RHS_func, (Nonlin_a - Nonlin_u), c, Gamma, phi_3, rel_tol)
    b_n_nl_2, rhs_calls_5 = Leja_phi(u, 9*dt/10, RHS_func, (Nonlin_a - Nonlin_u), c, Gamma, phi_3, rel_tol)
    ...
    u_nl_4_3, rhs_calls_6 = Leja_phi(u, dt, RHS_func, (-(312/81)*Nonlin_u + 2*Nonlin_a + (150/81)*Nonlin_b), c, Gamma, phi_3, rel_tol)
    u_nl_5_3, rhs_calls_7 = Leja_phi(u, dt, RHS_func, (-(1208/81)*Nonlin_u + 18*Nonlin_a - (250/81)*Nonlin_b), c, Gamma, phi_3, rel_tol)
    u_nl_5_4, rhs_calls_8 = Leja_phi(u, dt, RHS_func, ((1120/27)*Nonlin_u - 60*Nonlin_a + (500/27)*Nonlin_b), c, Gamma, phi_4, rel_tol)

    ### 4th and 5th order solutions
    u_exprb4 = u + (u_flux * dt) + (u_nl_4_3 * dt)
