...
def EPIRK4s3(u, T_final, RHS_function, c, Gamma, Leja_X, tol, Real_Imag):
    ...
    u_flux, rhs_calls_3 = linear_phi([zero_vec, rhs_u*T_final, zero_vec, (1892*R_a + 1458*(R_b - 2*R_a))*T_final, (-42336*R_a - 34992*(R_b - 2*R_a))*T_final], T_final, Jac_vec, 1, c, Gamma, Leja_X, tol)
