...
def EXPRB54s4(u, dt, RHS_function, c, Gamma, Leja_X, tol, Real_Imag):
    ...
    b_n_nl, rhs_calls_2 = Leja_phi(u, dt, RHS_function, R_a*dt, [1/2], c, Gamma, Leja_X, phi_3, tol)
    ...
    c_n_nl, rhs_calls_3 = Leja_phi(u, dt, RHS_function, R_b*dt, [9/10], c, Gamma, Leja_X, phi_3, tol)
