...
def EXPRB43(u, T_final, substeps, RHS_function, c, Gamma, Leja_X, tol, Real_Imag):
    """
    Parameters
    ----------
    u                       : numpy array
    ...
    u_flux_2, rhs_calls_2, substeps = linear_phi([zero_vec, (rhs_u + R_a)*T_final], T_final, substeps, Jac_vec, 1, c, Gamma, Leja_X, tol)
    ...
    u_flux, rhs_calls_3, substeps = linear_phi([zero_vec, rhs_u*T_final, zero_vec, (16*R_a-2*R_b)*T_final, (-48*R_a+12*R_b)*T_final], T_final, substeps, Jac_vec, 1, c, Gamma, Leja_X, tol)
