...
def imag_Leja_phi_nl(u, dt, RHS_function, interp_function, c, Gamma, Leja_X, phi_function, tol):
    """
    ...
    return np.real(polynomial), ii, convergence
