...
### Reference Solution
path = "./Allen_Cahn/T_final_0.05/N_400_eta_10/"
file_ref = path + "/EXPRB42/N_cfl_1.00/Final_data.txt"
...
def compute_error(solver):
	...
	file_1 = path + solver + "/N_cfl_50.00/Final_data.txt"
	file_2 = path + solver + "/N_cfl_100.00/Final_data.txt"
	file_3 = path + solver + "/N_cfl_200.00/Final_data.txt"
	file_4 = path + solver + "/N_cfl_300.00/Final_data.txt"
	file_5 = path + solver + "/N_cfl_400.00/Final_data.txt"
	file_6 = path + solver + "/N_cfl_500.00/Final_data.txt"
...
plt.savefig(path + "/Temporal_order_AC.eps")
