...
def EXPRB43(u, T_final, RHS_function, c, Gamma, Leja_X, tol, Real_Imag):
    ...
    ###? Interpolation 3; phi_1(J(u) dt) f(u) dt + phi_3(J(u) dt) (16R(a) - 2R(b)) dt
    u_flux, rhs_calls_3 = linear_phi([zero_vec, rhs_u*T_final, zero_vec, (16*R_a - 2*R_b)*T_final], T_final, Jac_vec, 1, c, Gamma, Leja_X, tol)
    
    ###? Interpolation 4; phi_4(J(u) dt) (-48R(a) + 12R(b)) dt
    u_nl, rhs_calls_4 = linear_phi([zero_vec, zero_vec, zero_vec, zero_vec, (-48*R_a + 12*R_b)*T_final], T_final, Jac_vec, 1, c, Gamma, Leja_X, tol)
