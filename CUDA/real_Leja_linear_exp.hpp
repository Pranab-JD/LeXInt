...
namespace LeXInt
{
    ...
    void real_Leja_linear_exp(rhs& RHS,                       //? RHS function
                              ...
                              double integrator_coeff,        //? Point where phi function is to be evaluated
                              ...
                              )
    {
        ...
        {
            matrix_exponential[ii] = exp(T_final * (c + (Gamma * Leja_X[ii])));
        }
