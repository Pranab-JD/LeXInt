...
namespace LeXInt
{
                   ...
                   )
    {
        ...
        real_Leja_phi(RHS, u, rhs_u, u_flux, auxiliary_Leja, N, {0.5, 0.9, 1.0}, 
        ...
        double* b_nl = &auxiliary_expint[8*N];
        ...
        double* b = &auxiliary_expint[10*N];
        ...
        double* R_3a = &auxiliary_expint[13*N];
        double* R_3b = &auxiliary_expint[14*N];
        double* R_4 = &auxiliary_expint[15*N];
        ...
        double* u_nl_4_3 = &auxiliary_expint[16*N];
        real_Leja_phi(RHS, u, R_3a, u_nl_4_3, auxiliary_Leja, N, {1.0},
                        phi_3, Leja_X, c, Gamma, tol, dt, iters_3, GPU, cublas_handle);

        //? phi_3(J(u) dt) (18R(a) - 250/81R(b)) dt
        double* u_nl_5_3 = &auxiliary_expint[17*N];
        real_Leja_phi(RHS, u, R_3b, u_nl_5_3, auxiliary_Leja, N, {1.0},
                        phi_3, Leja_X, c, Gamma, tol, dt, iters_4, GPU, cublas_handle);

        //? phi_4(J(u) dt) (-60R(a) + (500/27)R(b)) dt
        double* u_nl_5_4 = &auxiliary_expint[18*N];
