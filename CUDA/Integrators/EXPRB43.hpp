...
namespace LeXInt
{
                 ...
                 )
    {
        ...
        real_Leja_phi(RHS, u, rhs_u, u_flux, auxiliary_Leja, N, {0.5, 1.0}, 
        ...
        double* NL_b = &auxiliary_expint[6*N];
        double* R_a = &auxiliary_expint[7*N];
        double* R_b = &auxiliary_expint[8*N];
        ...
        real_Leja_phi(RHS, u, R_a, b_nl, auxiliary_Leja, N, {1.0}, 
