...
void EPIRK4s3(rhs& RHS,                   //? RHS function
              ...
              double* auxillary_expint,   //? Internal auxillary variables (EPIRK4s3)
              double* auxillary_Leja,     //? Internal auxillary variables (Leja)
              double* auxillary_NL,       //? Internal auxillary variables (EPIRK4s3 NL)
              ...
              )
{
    ...
    real_Leja_phi(RHS, u, rhs_u, u_flux, auxillary_Leja, N, {1./8., 1./9., 1.0}, 
