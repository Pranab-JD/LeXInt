...
def EXPRB32(u, T_final, RHS_function, c, Gamma, Leja_X, tol, Real_Imag):
    ...
    ###? Interpolation of R_a at 1; phi_3(J(u) dt) R(a) dt
    u_nl_3, rhs_calls_2 = linear_phi([zero_vec, zero_vec, zero_vec, 2*R_a*T_final], T_final, Jac_vec, 1, c, Gamma, Leja_X, tol)
